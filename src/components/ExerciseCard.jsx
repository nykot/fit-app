  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
        ...
        <div className='flex flex-col'>
            <h3 className='text-slate-400 text-sm'>Muscule Group</h3>
        ...
        <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-400 border-solid border-blue-900 hover:border-blue-600 w-full duration-200'>
