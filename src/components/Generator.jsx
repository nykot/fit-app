  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='flex items-center justify-center gap-2'>
        <p className='text-3xl sm:text-4xl md:text-4xl font-semibold text-slate-400'>{index}</p>
...
export default function Generator(props) {
  ...
  return (
    <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\s', 'Huge', 'o\'clock']}>
      ...
      <div className='grid grid-cols-2 sm:grid-flow-cols-4 gap-4'>
      ...
      <div className='bg-slate-950 border border-solid border-blue-400 rounded-lg relative flex flex-col'>
        <button  onClick={toggleModal} className='relatiev p-3 flex items-center justify-center'>
      ...
      <div className='grid grid-cols-1 sm:grids-cols-3 gap-4'>
